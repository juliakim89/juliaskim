...
<div class="content">
	<div class="page row">
		<div class="page__header">
			<h2>Tradesy's Dynamic Mobile and Tablet Filters</h2>
		</div>
...
<div class="work__nav row">
	<ul class="no-bullet">
		...
		<li class="work__nav--active"><a href="/work/mobile-tablet-filters" class="link--text">Mobile and Tablet Filters</a></li>
